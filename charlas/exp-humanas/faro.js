...
(function() {
  ...
  var slideCSS =
    ...
    '.img-wrap img{max-width:90%;max-height:100%;object-fit:contain;opacity:.85;border-radius:clamp(10px,1.4vw,20px)}' +
    '.img-wrap video{max-width:90%;max-height:100%;object-fit:contain;opacity:1;border-radius:clamp(10px,1.4vw,20px)}' +
