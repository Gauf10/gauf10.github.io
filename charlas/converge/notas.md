...
Emprendedor, mentor, speaker. También soy actor de improvisación, y eso me ayuda entre otras cosas, a escuchar y a responder sin juzgar ni juzgarme.
Hablo de esto porque me gusta acompañar equipos y proyectos. 
Y porque aprendí que una buena idea necesita encontrar la forma de llegar a otra persona.

## Conexión con clases anteriores
Esta clase es el paso siguiente. Ya tuvieron tres clases donde trabajaron: 
como observar problemas y convertirlos en oportunidades, 
identificar personas y situaciones concretas, 
definir resultados esperados, armar un Business Model Canvas, 
validar con personas reales, empezar una demo con IA.
...
Fundé y dirijo 5SEIS, una agencia donde diseñamos experiencias para marcas. 
Y hace algunos años empecé a llevar ese recorrido a otros lugares: trabajo con emprendedores, equipos y profesionales a través de mentorías, charlas y talleres, incorporando también herramientas de la improvisación teatral.
...
Con el tiempo aprendí que muchas veces las mejores herramientas aparecen cuando conectamos mundos que parecían separados: creatividad con liderazgo, improvisación con comunicación, diseño de experiencias con desarrollo humano.

Hoy estoy buscando llevar esa combinación a más personas y organizaciones, y seguir descubriendo qué nuevas posibilidades aparecen cuando ponemos en juego todo lo que fuimos aprendiendo en el camino.
...
# s16
## Dinámica — Pitch + Demo
**Paso 1:** Un equipo presenta su pitch (30 segundos).
...
**Paso 1:** Un estudiante hace un pitch (30 segundos).
