...
# s1
Miren todo lo que ya hicieron. Identificaron un problema o necesidad. Identificaron personas a las que les sucede. Armaron una propuesta. Completaron un Canvas. Hablaron con gente real (deberían hacerlo sino, incluso encuestas por redes sociales sirven para validar). Empezaron a construir una demo con IA.
